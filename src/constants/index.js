export const myProjects = [
  {
    ...
    description:
      "Developed a modern, interactive 3D developer portfolio that blends creativity and technology to showcase skills with immersive visuals and smooth animations.",
    subDescription: [
      "Built immersive 3D experiences with React Three Fiber and Drei, enhanced by Framer Motion for fluid animations and scroll-based interactions.",
      "Designed a responsive, modern UI using TailwindCSS, with additional enhancements from Aceternity UI and Magic UI.",
    ...
    tags: [
      {
        ...
        path: "/assets/logos/React-Three Fiber.jpeg",
      },
      {
        id: 2,
        name: "Framer Motion",
  ...
  },
  {
    ...
    description:
     "Developed a modern e-commerce platform with real-time product customization and integrated customer support, boosting overall user satisfaction by 35% and ensuring seamless shopping across all devices.",
    subDescription: [
      "Built a responsive and mobile-first UI using HTML5, CSS3, JavaScript, and Bootstrap 5, ensuring compatibility across devices and browsers.",
      "Implemented real-time product customization features, enhancing customer engagement and personalization.",
    ...
    tags: [
      ...
      },
      {
        id: 2,
        name: "Javascrip (ES6+)",
        path: "/assets/logos/Javascrip (ES6+).png",
      },
      {
        id: 3,
        name: "Material-UI (MUI)",
        path: "/assets/logos/material-ui-1.svg",
      },
      {
        id: 4,
        name: "CSS3",
  ...
  },
  {
    ...
    title: "Admin Panel",
    description:
      "Developed a scalable, multi-tenant admin panel with advanced access control, data visualization, and optimized backend performance.",
    subDescription: [
      "Designed a responsive and user-friendly interface using HTML5, CSS3, and Bootstrap 5.",
      "Implemented secure authentication, role-based access control, and optimized backend operations using Node.js and PHP.",
  ...
  {
    id: 4,
    title: "Dr. Finder ( Android Applcation )",
    description:
      "An Android application that connects users with nearby doctors in emergencies, providing real-time location tracking and optimized route guidance to improve response times.",
    subDescription: [
      "Developed a location-aware Android app using GPS and Google Maps API to track doctors and patients in real time.",
      "Optimized routing algorithms to reduce emergency response times by 30%.",
  ...
  {
    id: 5,
    title: "Online Tutor Finding System",
    description:
      "Developed a web platform connecting students and parents with qualified tutors, enabling real-time interactions, demo scheduling, and online bookings while enhancing accessibility and user experience.",
    subDescription: [
      "Built a multi-user system with distinct roles for Admin, Parents, and Tutors, supporting profile management, course booking, and rating functionality.",
      "Implemented real-time scheduling, demo lecture requests, and online tutor selection for enhanced learning convenience.",
...
export const mySocials = [
  {
    name: "WhatsApp",
    href: "https://wa.me/917306829986",

    icon: "/assets/socials/whatsApp.svg",
  },
  {
    name: "Linkedin",
    href: "https://www.linkedin.com/in/jikhil-reji-9292191b8",
    icon: "/assets/socials/linkedIn.svg",
  },
  {
    name: "Instagram",
    href: "https://github.com/JikhilReji",
...
export const reviews = [
  {
    name: "Aleena",
    username: "@aleena",
    body: "Working with Jikhil was an amazing experience. The project exceeded our expectations!",
    img: "https://robohash.org/aleena",
  },
  {
    name: "Diljith",
    username: "@diljith",
    body: "Highly professional and attentive to detail. Loved the final product.",
    img: "https://robohash.org/diljith",
  },
  {
    name: "Safal",
    username: "@safal",
    body: "Jikhil brought creativity and technical expertise together perfectly.",
    img: "https://robohash.org/safal",
  },
  {
    name: "Murali",
    username: "@murali",
    body: "The workflow was smooth, communication was great, and results were excellent.",
    img: "https://robohash.org/murali",
  },
  {
    name: "Anna",
    username: "@anna",
    body: "I highly recommend Jikhil for any web development project.",
    img: "https://robohash.org/anna",
  },
  {
    name: "Jayakrishnan",
    username: "@Jayakrishnan",
    body: "Creative, reliable, and extremely talented. Truly professional work.",
    img: "https://robohash.org/joseph",
  },
  {
    name: "Towin",
    username: "@towin",
    body: "Delivered more than what I expected. The project looks fantastic!",
    img: "https://robohash.org/towin",
  },
  {
    name: "Joseph",
    username: "@Josph",
    body: "Amazing attention to detail and very responsive throughout the project.",
    img: "https://robohash.org/alex",
  },
  {
    name: "Jasmin",
    username: "@jasmin",
    body: "Very professional, quick, and thorough. Highly recommended!",
    img: "https://robohash.org/jasmin",
  },
  {
    name: "Mathew",
    username: "@mathew",
    body: "Jikhil is an outstanding developer. The final result is exactly what we wanted.",
    img: "https://robohash.org/mathew",
  },
  {
    name: "Mariya",
    username: "@mariya",
    body: "Excellent communication and superb technical skills.",
    img: "https://robohash.org/mariya",
  },
  {
    name: "Joel",
    username: "@joel",
    body: "Professional, creative, and a joy to work with. I’m very satisfied!",
    img: "https://robohash.org/joel",
  },
  {
    name: "Ajay",
    username: "@ajay",
    body: "Delivered the project on time with amazing quality. Couldn’t ask for more.",
